...
basedir = 'C:\Users\lukas\Dropbox (Dartmouth College)\fMRI_emotion_Giao\BIDS\secondlevel\model_2_CANlab_single_trial_GLM';

% Set user options
% --------------------------------------------------------

a2_emosymp_m2_s2_set_default_options % lukasvo76: referring to renamed study- and model-specific script here, as I want to customize the default option - see my note in documentation above
...
scriptsdir = 'C:\Users\lukas\Documents\GitHub\proj-emosymp\secondlevel\model_2_CANlab_single_trial_GLM'; % lukasvo76: contrary to CANlab structure, I want my second level scripts to live in my Github local working dir for this study
